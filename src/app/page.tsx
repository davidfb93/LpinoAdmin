...
export default function Home() {
  ...
  if (isLoading) {
    return <Loading text="Verificando autenticación..." size="md" />;
  }
        ...
        <div className="px-4 py-6 sm:px-0">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600">
              Gestiona tu aplicación desde aquí. Has iniciado sesión como <span className="font-medium">{auth.user?.email}</span>
            </p>
          </div>
            ...
            <div className="bg-white overflow-hidden shadow rounded-lg">
              <div className="p-5">
                <div className="flex items-center">
                  ...
                  <div className="ml-5 w-0 flex-1">
                    <dl>
                      <dt className="text-sm font-medium text-gray-500 truncate">Crecimiento</dt>
